...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    configuration.clientID = @"8550eef2e3eb415389d08689bda44ffb6a827b00";
    configuration.accountBaseName = @"LobiRec";
...
{
    if ([NakamapRanking handleOpenURL:url]) {
        return YES;
    }
    return NO;
}
