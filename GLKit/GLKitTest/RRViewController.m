...
- (void)viewDidLoad
{
...

    {
        ...
        [self.startButton addTarget:self action:@selector(startCapture) forControlEvents:UIControlEventTouchUpInside];
        [self.view addSubview:self.startButton];
    }
    {
        self.stopButton = [UIButton buttonWithType:UIButtonTypeRoundedRect];
        self.stopButton.frame = (CGRect){80, 240, 80, 54};
        [self.stopButton setTitle:@"stop" forState:UIControlStateNormal];
        [self.stopButton addTarget:self action:@selector(stopCapture) forControlEvents:UIControlEventTouchUpInside];
...
- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect
{
    ...
    [[KLMVideoCapture sharedInstance] appendFrame:_frameBuffer];
